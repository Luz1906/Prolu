...
if (!isset($_SESSION['rol']) || $_SESSION['rol'] != 'COORD TOPO') {
...
<head>
    <meta charset="UTF-8">
    <title>Coordinación Topografía - Dashboard</title>
    ...
    <style>
        ...
        .sidebar {
            ...
            background: #fd7e14; color: white; padding-top: 20px;
        }
