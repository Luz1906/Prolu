...
if(isset($_POST['finalizar_id'])){
    ...
    header("Location: documentos_atendidos.php");
    exit();
}
...
// Consultar documentos atendidos o derivados para el área
$sql = "SELECT d.id, d.codigo, d.tipo_documento, d.asunto, d.fecha_ingreso, d.estado,
        ...
        WHERE d.estado IN ('ATENDIDO','DERIVADO') AND (a.nombre_area='$area_usuario' OR a.nombre_area IS NULL)
...
<head>
<meta charset="UTF-8">
<title>Documentos Atendidos - <?= htmlspecialchars($rol); ?></title>
...
<div class="content">
<h3>Documentos Atendidos / Derivados</h3>
